                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php $i = 1; ?>
                    ...
                    <tr>
                        ...
                        <td><img src="{{ asset($brand->image) }}" alt="{{ $brand->name }}" style="width: 100px; height: 100px;"></td>
                        <td>
                            @if ($brand->status == 1)
                        ...
                        <td class="d-flex">
                            <a href="{{ route('admin.brands.edit', $brand->id) }}" class="btn btn-primary btn-sm mr-2" title="Update"><i class="fa fa-edit"></i></a>
