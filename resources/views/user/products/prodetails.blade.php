                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-auto col-lg-3 col-xl-3 col-xxl-2">
                            ...
                            <a href="{{ url('/') }}" class="logo" style="margin-top: 0">
                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        <figure class="product-main-image">
                                            ...
                                            @if( $image->primary == 1 && $image->product_id == $products[2]->id)
                                            <img id="product-zoom" src="{{ asset($image->image) }}" data-zoom-image="{{ asset($image->image) }}" alt="product image">
                                            @endif
                                            @endforeach
                                        ...
                                        <div id="product-zoom-gallery" class="product-image-gallery">
                                            ...
                                            @elseif ( $image->primary == 1 && $image->product_id == $products[2]->id)
                                            <a class="product-gallery-item" href="#" data-image="/{{ $image->image }}" data-zoom-image="/{{ $image->image }}">
                                                <img src="/{{ $image->image }}" alt="product side">
                                            </a>
                                            @endif
                                            @endforeach
