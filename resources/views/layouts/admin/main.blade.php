...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/images/favicon_io/favicon-32x32.png') }}">
    <!-- Ionicons -->
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('admin.home') }}" class="brand-link">
                <img src="{{ asset('dist/img/logo.png') }}" alt=""
                    class="brand-image rounded-circle mr-3">
                <span class="brand-text font-weight-light"> Gift Card</span>
            </a>
