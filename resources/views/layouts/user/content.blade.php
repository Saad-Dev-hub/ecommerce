        ...
        <div class="row">
                            ...
                            <figure class="slide-image">
                                <picture>
                                    <source media="(max-width: 480px)"
                                        srcset="{{ asset('assets/images/demos/demo-14/slider/slide-1-480w.jpg') }}">
                                    <img src="{{ asset('assets/images/demos/demo-14/slider/slide-1.jpg') }}" alt="Image Desc">
                                </picture>
                        ...
                        <div class="intro-slide">
                            <figure class="slide-image">
                                <picture>
                                    ...
                                    <img src="{{ asset('assets/images/demos/demo-14/slider/slide-2.jpg') }}" alt="Image Desc">
                                </picture>
                            </figure><!-- End .slide-image -->
                        ...
                        <div class="intro-slide">
                            <figure class="slide-image">
                                <picture>
                                    ...
                                    <img src="{{asset('assets/images/demos/demo-14/slider/slide-3.jpg')}}" alt="Image Desc">
                                </picture>
                            </figure><!-- End .slide-image -->
            ...
            <div class="col-xl-3 col-xxl-2 d-none d-xxl-block">
                <div class="banner banner-overlay  banner-content-stretch ">
                    <a href="#">
                        <img src="{{ asset('assets/images/demos/demo-14/banners/banner-1.png') }}" alt="Banner img desc">
                    </a>
                    <div class="banner-content text-right">
                        ...
                        <a href="#" class="banner-link">Discover Now <i
            ...
            <div class="col-xl-9 col-xxl-10">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="banner banner-overlay">
                                    ...
                                    <div class="banner-content">
                                        <h4 class="banner-subtitle text-white d-none d-sm-block"><a
                                                href="#">Deal of the Day</a></h4><!-- End .banner-subtitle -->
                ...
                <div class="bg-lighter trending-products">
                            ...
                            <ul class="nav nav-pills justify-content-center" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="trending-elec-link" data-toggle="tab"
                                        href="#trending-elec-tab" role="tab" aria-controls="trending-elec-tab"
                                        aria-selected="false">Electronics</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="trending-furn-link" data-toggle="tab"
                                        href="#trending-furn-tab" role="tab" aria-controls="trending-furn-tab"
                                        aria-selected="false">Furniture</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="trending-cloth-link" data-toggle="tab"
                                        href="#trending-cloth-tab" role="tab" aria-controls="trending-cloth-tab"
                                        aria-selected="false">Clothes</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="trending-acc-link" data-toggle="tab"
                                        href="#trending-acc-tab" role="tab" aria-controls="trending-acc-tab"
                    ...
                    <div class="tab-content tab-content-carousel">
                            ...
                            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow"
                                ...
                                <div class="product text-center">
                                    <figure class="product-media">
                                        ...
                                        <a href="product.html">
                                            <img src="assets/images/demos/demo-14/products/product-1.jpg"
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product.html">Butler Stool
                                                Ladder</a></h3><!-- End .product-title -->
                                ...
                                <div class="product text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <div class="product-nav product-nav-dots">
                                            <a href="#" class="active"
                                                style="background: #69b4ff;"><span class="sr-only">Color
                                                    name</span></a>
                        ...
                        <div class="tab-pane p-0 fade" id="trending-elec-tab" role="tabpanel"
                        ...
                        <div class="tab-pane p-0 fade" id="trending-furn-tab" role="tabpanel"
                        ...
                        <div class="tab-pane p-0 fade" id="trending-cloth-tab" role="tabpanel"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="banner banner-overlay">
                            <a href="#">
                                <img src="assets/images/demos/demo-14/banners/banner-7.jpg"
                                    alt="Banner img desc">
                            </a>
                    ...
                    <div class="col-md-6">
                        <div class="banner banner-overlay">
                            <a href="#">
                                <img src="assets/images/demos/demo-14/banners/banner-8.jpg"
                                    alt="Banner img desc">
                            </a>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-xl-12">
                                        <div class="product text-center">
                                            ...
                                            <div class="product-countdown" data-until="+44h"
                                    ...
                                    <div class="col-sm-6 col-xl-12">
                                        <div class="product text-center">
                                            ...
                                            <div class="product-countdown" data-until="+52h"
                                                data-relative="true" data-labels-short="true"></div>
                                            <!-- End .product-countdown -->
                                        </div><!-- End .product -->
                                    </div><!-- End .col-sm-6 col-xl-12 -->
