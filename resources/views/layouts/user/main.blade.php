                                                        ...
                                                        @auth
                                                            <ul class="navbar-nav">
                                                                <li class="nav-item dropdown mr-3">
                                                                    ...
                                                                    <div class="dropdown-menu mr-5 p-2"
                                                                        aria-labelledby="navbarDropdownMenuLink">
                                                                        <a class="dropdown-item" href="#" style="font-size: 14px">Edit
                                                                            Profile</a>
                                    ...
                                    <div class="row">
                                        <div class="col-auto col-lg-3 col-xl-3 col-xxl-2">
                                            ...
                                            <a href="{{ url('/user') }}" class="logo" style="margin-top: 0">
                                                <img src="{{ asset('assets/images/Capture.PNG') }}" alt="Molla Logo" width="150"
                                                    height="40">
                                            </a>
                                                    ...
                                                    <div
                                                        ...
                                                        <form action="#" method="get">
                                                            <div class="header-search-wrapper search-wrapper-wide">
                                                                ...
                                                                <input type="search" name="search" class="form-control" name="q" id="q"
                                                    ...
                                                    <nav class="side-nav">
                                                        <ul class="menu-vertical sf-arrows">
                                                            <li class="megamenu-container">
                                                                <a class="sf-with-ul" href="#"><i class="icon-laptop"></i>All
                                                                    Categories</a>
                                                                                        ...
                                                                                        <div class="col-md-6">
                                                                                            ...
                                                                                            <ul>
                                                                                                @foreach ($category->subcategories as $subcategory)
                                                                                                    <li><a
                                                                                                            href="{{ route('user.subcategories.show', $subcategory->id) }}">{{ $subcategory->name }}</a>
                                                                                                    </li>
                                                                                                @endforeach
                                                                                            </ul>
                                                                                        </div><!-- End .col-md-6 -->
                                                            ...
                                                            {{-- <li class="megamenu-container">
                                                                <a class="sf-with-ul" href="#"><i
                                                                        class="icon-couch"></i>Furniture</a>
                                                            ...
                                                            <li class="megamenu-container">
                                                                <a class="sf-with-ul" href="#"><i
                                                                        class="icon-tshirt"></i>Clothing</a>
                                                                                                ...
                                                                                                @if ($category->name == 'Clothing')
                                                                                                    @foreach ($category->subcategories as $subcategory)
                                                                                                        @if ($subcategory->name == 'Women')
                                                                                                            <li><a
                                                                                                                    href="{{ route('user.subcategories.show', $subcategory->id) }}">
                                                                                                    ...
                                                                                                    @foreach ($category->subcategories as $subcategory)
                                                                                                        @if ($subcategory->name == 'Men')
                                                                                                            <li><a
                                                                                                                    href="{{ route('user.subcategories.show', $subcategory->id) }}">
                                                                                                                    <strong
                                                                                                                        class="menu-title">{{ $subcategory->name }}</strong></a>
                                                                                                            </li>
                                                                                                        @endif
                                                                                                    @endforeach
                                                                                                @endif
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                        ...
                                                                                        <ul>
                                                                                            @forelse ($categories as $category)
                                                                                                @if ($category->name == 'Clothing')
                                                                                                    @foreach ($category->subcategories as $subcategory)
                                                                                                        @if ($subcategory->name == 'Sunglasses')
                                                                                                            <li><a
                                                                                                                    href="{{ route('user.subcategories.show', $subcategory->id) }}">
                                                                                                                    <strong class="menu-title">{{ $subcategory->name }}</strong></a>
                                                                                                            </li>
                                ...
                                <div class="row">
                                            ...
                                            <div class="intro-slider owl-carousel owl-simple owl-nav-inside" data-toggle="owl"
                                                ...
                                                <div class="intro-slide">
                                                    <figure class="slide-image">
                                                        <picture>
                                                            <source media="(max-width: 480px)"
                                                                srcset="{{ asset('assets/images/demos/demo-14/slider/slide-2-480w.jpg') }}">
                                                            <img src="{{ asset('assets/images/demos/demo-14/slider/slide-2.jpg') }}"
                                                                alt="Image Desc">
                                                        </picture>
                                                    </figure><!-- End .slide-image -->
                                                ...
                                                <div class="intro-slide">
                                                    <figure class="slide-image">
                                                        <picture>
                                                            <source media="(max-width: 480px)"
                                                                srcset="{{ asset('assets/images/demos/demo-14/slider/slide-3-480w.jpg') }}">
                                                            <img src="{{ asset('assets/images/demos/demo-14/slider/slide-3.jpg') }}"
                                                                alt="Image Desc">
                                                        </picture>
                                                    </figure><!-- End .slide-image -->
                                    ...
                                    <div class="col-xl-3 col-xxl-2 d-none d-xxl-block">
                                        <div class="banner banner-overlay  banner-content-stretch ">
                                            <a href="#">
                                                <img src="{{ asset('assets/images/demos/demo-14/banners/banner-1.png') }}"
                                                    alt="Banner img desc">
                                            </a>
                                    ...
                                    <div class="col-xl-9 col-xxl-10">
                                        <div class="row">
                                            <div class="col-lg-12 col-xxl-4-5col">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="banner banner-overlay">
                                                            <a href="#">
                                                                <img src="{{ asset('assets/images/demos/demo-14/banners/banner-2.jpg') }}"
                                                                    alt="Banner img desc">
                                                            </a>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="banner banner-overlay">
                                                            <a href="#">
                                                                <img src="{{ asset('assets/images/demos/demo-14/banners/banner-3.png') }}"
                                                                    alt="Banner img desc">
                                                            </a>
                                            ...
                                            <div class="col-12 col-xxl-5col d-none d-xxl-block">
                                                <div class="banner banner-overlay">
                                                    <a href="#">
                                                        <img src="{{ asset('assets/images/demos/demo-14/banners/banner-4.jpg') }}"
                                                            alt="Banner img desc">
                                                    </a>
                                                    ...
                                                    <div class="banner-content">
                                                        ...
                                                        <!-- End .banner-subtitle -->
                                                        <h3 class="banner-title text-white"><a href="#">Seating and Tables
                                                                Clearance</a></h3><!-- End .banner-title -->
                                                        <a href="#" class="banner-link">Shop Now <i
                                                                class="icon-long-arrow-right"></i></a>
                                                    </div><!-- End .banner-content -->
                                                </div><!-- End .banner banner-overlay -->
                                        ...
                                        <div class="owl-carousel owl-simple brands-carousel" data-toggle="owl" data-owl-options='{
                                            ...
                                            @auth
                                                {{-- @foreach ($brandsImages as $image)
                                                    <div class="brand">
                                                        <a href="#">
                                                            <img class="w-50 h-50" src="{{ asset($image->image) }}" alt="Brand logo">
                                                        </a>
                                                    </div><!-- End .brand-item -->
                                                @endforeach --}}
                                            @endauth
                                        ...
                                        <div class="bg-lighter trending-products">
                                            <div class="heading heading-flex mb-3">
                                                ...
                                                <div class="heading-right">
                                                    <ul class="nav nav-pills justify-content-center" role="tablist">
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="trending-elec-link" data-toggle="tab"
                                                                href="#trending-women-tab" role="tab" aria-controls="trending-women-tab"
                                                                aria-selected="false">Women</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="trending-furn-link" data-toggle="tab"
                                                                href="#trending-men-tab" role="tab" aria-controls="trending-men-tab"
                                                                aria-selected="false">Men</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="trending-cloth-link" data-toggle="tab"
                                                                href="#trending-glass-tab" role="tab" aria-controls="trending-glass-tab"
                                                                aria-selected="false">Sunglasses</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="trending-acc-link" data-toggle="tab"
                                                                href="#trending-child-tab" role="tab" aria-controls="trending-child-tab"
                                                                aria-selected="false">Children</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="trending-acc-link" data-toggle="tab"
                                                                href="#trending-scarf-tab" role="tab" aria-controls="trending-scarf-tab"
                                                                aria-selected="false">Scarf</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="trending-acc-link" data-toggle="tab"
                                                                href="#trending-Handmade-tab" role="tab" aria-controls="trending-Handmade-tab"
                                                                aria-selected="false">Handmade</a>
                                                        </li>
                                            ...
                                            <div class="tab-content tab-content-carousel">
                                                        ...
                                                        <div class="product text-center">
                                                            ...
                                                            <div class="product-body">
                                                                <div class="product-cat">
                                                                    <a href="#">{{ $product1->subcategory_name }}</a>
                                                                </div><!-- End .product-cat -->
                                                                <h3 class="product-title"><a href="product.html">{{ $product1->name }}
                                                                        </a></h3><!-- End .product-title -->
                                                                <div class="product-price">
                                                                    <span class="new-price">{{$product1->price}}</span>
                                                ...
                                                <div class="tab-pane p-0 fade" id="trending-women-tab" role="tabpanel"
                                                    aria-labelledby="trending-elec-link">
                                                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow"
                                                        data-toggle="owl" data-owl-options='{
                                                        "nav": false,
                                                        "dots": true,
                                                    ...
                                                    <div class="product text-center">
                                                            ...
                                                            <div class="product-action">
                                                                <a href="{{ route('user.product.view',$women->id) }}" class="btn-product btn-quickview"
                                                                    ...
                                                                    @if(Auth :: check())
                                                                        <form action="{{ route('user.carts.store') }}" method="POST">
                                                                            @csrf
                                                                            <input type="hidden" name="product_id" value="{{ $women->id }}">
                                                                            <input type="hidden" name="quantity" value="1">
                                                                            <button type="submit" class="btn-product btn-cart"><span>add to cart</span></button>
                                                                        </form>
                                                                    @else
                                                        ...
                                                        <div class="product-body">
                                                            ...
                                                            <h3 class="product-title"><a href="product.html">{{ $women->name }}</a></h3><!-- End .product-title -->
                                                            <div class="product-price">
                                                                {{ $women->price }}
                                                            </div><!-- End .product-price -->
                                                            <div class="ratings-container">
                                                ...
                                                <div class="tab-pane p-0 fade" id="trending-men-tab" role="tabpanel"
                                                    aria-labelledby="trending-furn-link">
                                                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow"
                                                        data-toggle="owl" data-owl-options='{
                                                        "nav": false,
                                                        "dots": true,
                                                    ...
                                                    <div class="product text-center">
                                                            ...
                                                            <div class="product-action">
                                                                <a href="{{ route('user.product.view',$men->id) }}" class="btn-product btn-quickview"
                                                                    ...
                                                                    @if(Auth :: check())
                                                                        <form action="{{ route('user.carts.store') }}" method="POST">
                                                                            @csrf
                                                                            <input type="hidden" name="product_id" value="{{ $men->id }}">
                                                                            <input type="hidden" name="quantity" value="1">
                                                                            <button type="submit" class="btn-product btn-cart"><span>add to cart</span></button>
                                                                        </form>
                                                                    @else
                                                        ...
                                                        <div class="product-body">
                                                            <div class="product-cat">
                                                                <a href="#">{{ $men->subcategory_name }}</a>
                                                            </div><!-- End .product-cat -->
                                                            <h3 class="product-title"><a href="product.html">{{ $men->name }}</a></h3><!-- End .product-title -->
                                                            <div class="product-price">
                                                              {{$men->price}}
                                                            </div><!-- End .product-price -->
                                                            <div class="ratings-container">
                                                ...
                                                <div class="tab-pane p-0 fade" id="trending-glass-tab" role="tabpanel"
                                                    aria-labelledby="trending-cloth-link">
                                                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow"
                                                        data-toggle="owl" data-owl-options='{
                                                        "nav": false,
                                                        "dots": true,
                                                    ...
                                                    <div class="product text-center">
                                                            ...
                                                            <div class="product-action">
                                                                <a href="{{ route('user.product.view',$sunglass->id) }}" class="btn-product btn-quickview"
                                                                    ...
                                                                    @if(Auth :: check())
                                                                        <form action="{{ route('user.carts.store') }}" method="POST">
                                                                            @csrf
                                                                            <input type="hidden" name="product_id" value="{{ $sunglass->id }}">
                                                                            <input type="hidden" name="quantity" value="1">
                                                                            <button type="submit" class="btn-product btn-cart"><span>add to cart</span></button>
                                                                        </form>
                                                                    @else
                                                        ...
                                                        <div class="product-body">
                                                            <div class="product-cat">
                                                                <a href="#">{{$sunglass->subcategory_name}}</a>
                                                            </div><!-- End .product-cat -->
                                                            <h3 class="product-title"><a href="product.html">{{$sunglass->name}}</a></h3><!-- End .product-title -->
                                                            <div class="product-price">
                                                                <span class="new-price">{{$sunglass->price}}</span>
                                                            </div><!-- End .product-price -->
                                                            <div class="ratings-container">
                                                                <div class="ratings">
                                                                    <div class="ratings-val" style="width: 100%;"></div>
                                                ...
                                                <div class="tab-pane p-0 fade" id="trending-child-tab" role="tabpanel"
                                                    ...
                                                    <div class="product text-center">
                                                        ...
                                                        <div class="product-body">
                                                            ...
                                                            <h3 class="product-title"><a href="product.html">{{ $child->name }}</a></h3><!-- End .product-title -->
                                                            <div class="product-price">
                                                                {{$child->price}}
                                                            </div><!-- End .product-price -->
                                                            <div class="ratings-container">
                                                ...
                                                <div class="tab-pane p-0 fade" id="trending-scarf-tab" role="tabpanel"
                                                    ...
                                                    <div class="product text-center">
                                                            ...
                                                            <div class="product-action">
                                                                <a href="{{ route('user.product.view',$scarf->id) }}" class="btn-product btn-quickview"
                                                                    ...
                                                                    @if(Auth :: check())
                                                                        <form action="{{ route('user.carts.store') }}" method="POST">
                                                                            @csrf
                                                                            <input type="hidden" name="product_id" value="{{ $scarf->id }}">
                                                                            <input type="hidden" name="quantity" value="1">
                                                                            <button type="submit" class="btn-product btn-cart"><span>add to cart</span></button>
                                                                        </form>
                                                                    @else
                                                        ...
                                                        <div class="product-body">
                                                            ...
                                                            <h3 class="product-title"><a href="product.html">{{ $scarf->name }}</a></h3><!-- End .product-title -->
                                                            <div class="product-price">
                                                                {{$scarf->price}}
                                                            </div><!-- End .product-price -->
                                                            <div class="ratings-container">
                                                ...
                                                aria-labelledby="trending-Handmade-link">
                                                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow"
                                                    data-toggle="owl" data-owl-options='{
                                                    "nav": false,
                                                    "dots": true,
                                                ...
                                                <div class="product text-center">
                                                        ...
                                                        <div class="product-action">
                                                            <a href="{{ route('user.product.view',$handmade->id) }}" class="btn-product btn-quickview"
                                                                ...
                                                                @if(Auth :: check())
                                                                    <form action="{{ route('user.carts.store') }}" method="POST">
                                                                        @csrf
                                                                        <input type="hidden" name="product_id" value="{{ $handmade->id }}">
                                                                        <input type="hidden" name="quantity" value="1">
                                                                        <button type="submit" class="btn-product btn-cart"><span>add to cart</span></button>
                                                                    </form>
                                                                @else
                                                    ...
                                                    <div class="product-body">
                                                        ...
                                                        <h3 class="product-title"><a href="product.html">{{ $handmade->name }}</a></h3><!-- End .product-title -->
                                                        <div class="product-price">
                                                            {{$handmade->price}}
                                                        </div><!-- End .product-price -->
                                                        <div class="ratings-container">
                                            ...
                                            <div class="col-xl-3 col-xxl-4">
                                                <div class="cat-banner row no-gutters">
                                                    ...
                                                    <div class="col-sm-6 col-xl-12 col-xxl-6">
                                                        <div class="banner banner-overlay">
                                                            <a href="#">
                                                                <img src="assets/images/demos/demo-14/banners/banner-5.jpg"
                                                                    alt="Banner img desc">
                                                            </a>
                                                            ...
                                                            <div class="banner-content">
                                                                ...
                                                                <h3 class="banner-title text-white"><a href="#">Canon EOS <br>Mega Sale
                                                                        <br><span>Up To 20% Off</span></a></h3>
                                                                <!-- End .banner-title -->
                                                                <a href="#" class="banner-link">Shop Now <i
                                                                        class="icon-long-arrow-right"></i></a>
                                                            </div><!-- End .banner-content -->
                                            ...
                                            <div class="col-xl-9 col-xxl-8">
                                                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow"
                                                    ...
                                                    <div class="product text-center">
                                                        <figure class="product-media">
                                                            <a href="product.html">
                                                                <img src="assets/images/demos/demo-14/products/product-7.jpg"
                                                                    alt="Product image" class="product-image">
                                                            </a>
                                                    ...
                                                    <div class="product text-center">
                                                        <figure class="product-media">
                                                            ...
                                                            <a href="product.html">
                                                                <img src="assets/images/demos/demo-14/products/product-8.jpg"
                                                                    alt="Product image" class="product-image">
                                                            </a>
                                                        ...
                                                        <div class="product-body">
                                                            ...
                                                            <h3 class="product-title"><a href="product.html">Apple - 11 Inch iPad Pro
                                                                    <br>with Wi-Fi 256GB </a></h3><!-- End .product-title -->
                                                            <div class="product-price">
                                                                $899.99
                                                            </div><!-- End .product-price -->
                                                            <div class="ratings-container">
                                                    ...
                                                    <div class="product text-center">
                                                        <figure class="product-media">
                                                            ...
                                                            <span class="product-label label-sale">Sale</span>
                                                            <a href="product.html">
                                                                <img src="assets/images/demos/demo-14/products/product-9.jpg"
                                                                    alt="Product image" class="product-image">
                                                            </a>
                                            ...
                                            <div class="col-xl-3 col-xxl-4">
                                                <div class="cat-banner row no-gutters">
                                                    ...
                                                    <div class="col-sm-6 col-xl-12 col-xxl-6">
                                                        <div class="banner banner-overlay">
                                                            <a href="#">
                                                                <img src="assets/images/demos/demo-14/banners/banner-6.jpg"
                                                                    alt="Banner img desc">
                                                            </a>
                                                            ...
                                                            <div class="banner-content">
                                                                ...
                                                                <h3 class="banner-title text-white"><a href="#">Furniture Sets
                                                                        <br><span>Up To 30% Off</span></a></h3>
                                                                <!-- End .banner-title -->
                                                                <a href="#" class="banner-link">Shop Now <i
                                                                        class="icon-long-arrow-right"></i></a>
                                                            </div><!-- End .banner-content -->
                                                ...
                                                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow"
                                                    ...
                                                    <div class="product text-center">
                                                        <figure class="product-media">
                                                            <span class="product-label label-new">New</span>
                                                            <a href="product.html">
                                                                <img src="assets/images/demos/demo-14/products/product-10.jpg"
                                                                    alt="Product image" class="product-image">
                                                            </a>
                                                        ...
                                                        <div class="product-body">
                                                            ...
                                                            <div class="product-nav product-nav-dots">
                                                                <a href="#" class="active" style="background: #333333;"><span
                                                                        class="sr-only">Color name</span></a>
                                                                <a href="#" style="background: #e2e2e2;"><span
                                                                        class="sr-only">Color name</span></a>
                                                            </div><!-- End .product-nav -->
                                                        </div><!-- End .product-body -->
                                                    </div><!-- End .product -->
                                                    ...
                                                    <div class="product text-center">
                                                        <figure class="product-media">
                                                            <a href="product.html">
                                                                <img src="assets/images/demos/demo-14/products/product-11.jpg"
                                                                    alt="Product image" class="product-image">
                                                            </a>
                                                    ...
                                                    <div class="product text-center">
                                                        <figure class="product-media">
                                                            <span class="product-label label-sale">Sale</span>
                                                            <a href="product.html">
                                                                <img src="assets/images/demos/demo-14/products/product-12.jpg"
                                                                    alt="Product image" class="product-image">
                                                            </a>
                                                        ...
                                                        <div class="product-body">
                                                            ...
                                                            <h3 class="product-title"><a href="product.html">Carronade Large
                                                                    <br>Suspension Lamp</a></h3><!-- End .product-title -->
                                                            <div class="product-price">
                                                            ...
                                                            <div class="product-nav product-nav-dots">
                                                                <a href="#" class="active" style="background: #f7f6f5;"><span
                                                                        class="sr-only">Color name</span></a>
                                                                <a href="#" style="background: #825a45;"><span
                                                                        class="sr-only">Color name</span></a>
                                                            </div><!-- End .product-nav -->
                                                        </div><!-- End .product-body -->
                                                    </div><!-- End .product -->
                                                    ...
                                                    <div class="product text-center">
                                                        <figure class="product-media">
                                                            <a href="product.html">
                                                                <img src="assets/images/demos/demo-14/products/product-13.jpg"
                                                                    alt="Product image" class="product-image">
                                                            </a>
                                                        ...
                                                        <div class="product-body">
                                                            ...
                                                            <div class="product-nav product-nav-dots">
                                                                <a href="#" class="active" style="background: #999999;"><span
                                                                        class="sr-only">Color name</span></a>
                                                                <a href="#" style="background: #cc9999;"><span
                                                                        class="sr-only">Color name</span></a>
                                                            </div><!-- End .product-nav -->
                                                        </div><!-- End .product-body -->
                                                    </div><!-- End .product -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="banner banner-overlay">
                                                    ...
                                                    <div class="banner-content">
                                                        <h4 class="banner-subtitle text-white d-none d-sm-block"><a href="#">Spring
                                                                Sale is Coming</a></h4><!-- End .banner-subtitle -->
                                            ...
                                            <div class="col-xl-3 col-xxl-4">
                                                <div class="cat-banner row no-gutters">
                                                    ...
                                                    <div class="col-sm-6 col-xl-12 col-xxl-6">
                                                        <div class="banner banner-overlay">
                                                            <a href="#">
                                                                <img src="assets/images/demos/demo-14/banners/banner-9.jpg"
                                                                    alt="Banner img desc">
                                                            </a>
                                            ...
                                            <div class="col-xl-9 col-xxl-8">
                                                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow"
                                                    ...
                                                    <div class="product text-center">
                                                        <figure class="product-media">
                                                            <a href="product.html">
                                                                <img src="assets/images/demos/demo-14/products/product-14.jpg"
                                                                    alt="Product image" class="product-image">
                                                            </a>
                                                        ...
                                                        <div class="product-body">
                                                            ...
                                                            <h3 class="product-title"><a href="product.html">Beige faux suede runner
                                                    ...
                                                    <div class="product text-center">
                                                        <figure class="product-media">
                                                            <span class="product-label label-new">New</span>
                                                            <a href="product.html">
                                                                <img src="assets/images/demos/demo-14/products/product-15.jpg"
                                                                    alt="Product image" class="product-image">
                                                            </a>
                                                        ...
                                                        <div class="product-body">
                                                            ...
                                                            <h3 class="product-title"><a href="product.html">Black boucle check
                                                                    scarf</a></h3><!-- End .product-title -->
                                                            <div class="product-price">
                                                                $36.00
                                                            </div><!-- End .product-price -->
                                                            <div class="ratings-container">
                                                    ...
                                                    <div class="product text-center">
                                                        <figure class="product-media">
                                                            <a href="product.html">
                                                                <img src="assets/images/demos/demo-14/products/product-16.jpg"
                                                                    alt="Product image" class="product-image">
                                                            </a>
                                                    ...
                                                    <div class="product text-center">
                                                        <figure class="product-media">
                                                            <a href="product.html">
                                                                <img src="assets/images/demos/demo-14/products/product-17.jpg"
                                                                    alt="Product image" class="product-image">
                                                            </a>
                                                        ...
                                                        <div class="product-body">
                                                            ...
                                                            <h3 class="product-title"><a href="product.html">Triple compartment cross
                                                ...
                                                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow"
                                                    ...
                                                    <div class="product text-center">
                                                        ...
                                                        <div class="product-body">
                                                            ...
                                                            <h3 class="product-title"><a href="product.html">KitchenAid Professional
                                                                    500 Series Stand Mixer</a></h3><!-- End .product-title -->
                                                            <div class="product-price">
                                                    ...
                                                    <div class="product text-center">
                                                        ...
                                                        <div class="product-body">
                                                            ...
                                                            <h3 class="product-title"><a href="product.html">MoDRN Industrial 7
                                                    ...
                                                    <div class="product text-center">
                                                        ...
                                                        <div class="product-body">
                                                            ...
                                                            <h3 class="product-title"><a href="product.html">Cuisinart French Classic
                                                                    3 Piece</a></h3><!-- End .product-title -->
                                                            <div class="product-price">
                                                                $44.99
                                                            </div><!-- End .product-price -->
                                                            <div class="ratings-container">
                                                    ...
                                                    <div class="product text-center">
                                                        ...
                                                        <div class="product-body">
                                                            ...
                                                            <h3 class="product-title"><a href="product.html">KitchenAid - KSB1570WH
                                                                    Classic 5-Speed Blender</a></h3><!-- End .product-title -->
                                                            <div class="product-price">
                                                                $75.00
                                                            </div><!-- End .product-price -->
                                                            <div class="ratings-container">
                                                            ...
                                                            <div class="product-nav product-nav-dots">
                                                                <a href="#" class="active" style="background: #f1f1f1;"><span
                                                                        class="sr-only">Color name</span></a>
                                                                <a href="#" style="background: #c00b1b;"><span
                                                                        class="sr-only">Color name</span></a>
                                                            </div><!-- End .product-nav -->
                                                        </div><!-- End .product-body -->
                                                    </div><!-- End .product -->
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 col-xl-12">
                                                    <div class="widget widget-banner">
                                                        <div class="banner banner-overlay">
                                                            <a href="#">
                                                                <img src="assets/images/demos/demo-14/banners/banner-11.jpg"
                                                                    alt="Banner img desc">
                                                            </a>

                                                            <div
                                                                class="banner-content banner-content-top banner-content-right text-right">
                                                    ...
                                                    <div class="widget widget-products">
                                                        ...
                                                        <div class="products">
                                                            <div class="product product-sm">
                                                                <figure class="product-media">
                                                                    <a href="product.html">
                                                                        <img src="assets/images/demos/demo-14/products/small/product-1.jpg"
                                                                            alt="Product image" class="product-image">
                                                                    </a>
                                                                </figure>

                                                                <div class="product-body">
                                                                    <h5 class="product-title"><a href="product.html">Sceptre 50"
                                                                            Class FHD (1080P) LED TV</a></h5><!-- End .product-title -->
                                                                    <div class="product-price">
                                                                        $199.99
                                                                    </div><!-- End .product-price -->
                                                                </div><!-- End .product-body -->
                                                            ...
                                                            <div class="product product-sm">
                                                                <figure class="product-media">
                                                                    <a href="product.html">
                                                                        <img src="assets/images/demos/demo-14/products/small/product-2.jpg"
                                                                            alt="Product image" class="product-image">
                                                                    </a>
                                                                </figure>

                                                                <div class="product-body">
                                                                    <h5 class="product-title"><a href="product.html">Red Cookware
                                                                            Set, 9 Piece</a></h5><!-- End .product-title -->
                                                                    <div class="product-price">
                                                                        $24.95
                                                                    </div><!-- End .product-price -->
                                                                </div><!-- End .product-body -->
                                                            ...
                                                            <div class="product product-sm">
                                                                <figure class="product-media">
                                                                    <a href="product.html">
                                                                        <img src="assets/images/demos/demo-14/products/small/product-3.jpg"
                                                                            alt="Product image" class="product-image">
                                                                    </a>
                                                                </figure>

                                                                <div class="product-body">
                                                                    <h5 class="product-title"><a href="product.html">Epson WorkForce
                                                                            WF-2750 All-in-One Wireless</a></h5>
                                                                    <!-- End .product-title -->
                                                                    <div class="product-price">
                                                                        $49.99
                                                                    </div><!-- End .product-price -->
                                                            ...
                                                            <div class="product product-sm">
                                                                <figure class="product-media">
                                                                    <a href="product.html">
                                                                        <img src="assets/images/demos/demo-14/products/small/product-4.jpg"
                                                                            alt="Product image" class="product-image">
                                                                    </a>
                                                                </figure>
                                                            ...
                                                            <div class="product product-sm">
                                                                <figure class="product-media">
                                                                    <a href="product.html">
                                                                        <img src="assets/images/demos/demo-14/products/small/product-5.jpg"
                                                                            alt="Product image" class="product-image">
                                                                    </a>
                                                                </figure>
                                                            ...
                                                            <div class="col-sm-6 col-xl-12">
                                                                <div class="product text-center">
                                                                    ...
                                                                    <div class="product-body">
                                                                        ...
                                                                        <h3 class="product-title"><a href="product.html">Bose
                                                                                SoundLink Micro speaker</a></h3>
                                                                        <!-- End .product-title -->
                                                                        <div class="product-price">
                                                        ...
                                                        <div class="banner banner-overlay">
                                                            ...
                                                            <div class="banner-content banner-content-top">
                                                                <h3 class="banner-title text-white"><a href="#">Take Better Photos
                                                                        <br><span>With</span> Canon EOS <br><span>Up To 20%
                                                        ...
                                                        <div class="owl-carousel owl-simple" data-toggle="owl" data-owl-options='{
                                                            ...
                                                            <article class="entry">
                                                                <figure class="entry-media">
                                                                    <a href="single.html">
                                                                        <img src="assets/images/demos/demo-14/blog/post-1.jpg"
                                                                            alt="image desc">
                                                                    </a>
                                                                ...
                                                                <div class="entry-body">
                                                                    ...
                                                                    <div class="entry-content">
                                                                        <p>Lorem ipsum dolor consectetuer adipiscing elit. Phasellus
                                                                            hendrerit. Pelletesque aliquet nibh ...</p>
                                                            ...
                                                            <article class="entry">
                                                                <figure class="entry-media">
                                                                    <a href="single.html">
                                                                        <img src="assets/images/demos/demo-14/blog/post-2.jpg"
                                                                            alt="image desc">
                                                                    </a>
                                                                </figure><!-- End .entry-media -->
                                                                ...
                                                                <div class="entry-body">
                                                                    ...
                                                                    <div class="entry-content">
                                                                        <p>Phasellus hendrerit. Pelletesque aliquet nibh necurna In nisi
                                                                            neque, aliquet vel, dapibus id ... </p>
                                                                        <a href="single.html" class="read-more">Read More</a>
                                                                    </div><!-- End .entry-content -->
                                                                </div><!-- End .entry-body -->
                                                            </article><!-- End .entry -->
                                                            ...
                                                            <article class="entry">
                                                                <figure class="entry-media">
                                                                    <a href="single.html">
                                                                        <img src="assets/images/demos/demo-14/blog/post-3.jpg"
                                                                            alt="image desc">
                                                                    </a>
                                                                </figure><!-- End .entry-media -->
